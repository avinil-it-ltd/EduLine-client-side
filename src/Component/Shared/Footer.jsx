...
const Footer = () => {
    return (
        <div>
            <footer className=" container  mx-auto footer p-10 bg-orange-200 shadow-md font-mono  text-base-content">
                <div>
            ...
            <footer className="container  mx-auto  footer px-10 py-4 border-t bg-orange-200 text-base-content font-mono font-bold border-base-300">
